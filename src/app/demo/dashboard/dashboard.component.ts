...
export class DashboardComponent implements OnInit {
	...
	//   { img: 'assets/images/men.png', title: "Men's Salon & Massage" },
	//   { img: 'assets/images/ac.png', title: "AC & Appliance Repair" },
	//   { img: 'assets/images/cleaning.png', title: "Cleaning" },
	//   { img: 'assets/images/painting.png', title: "Full home painting" },
	// ];

	//To store data of Top trending sub-categories
	topTrendingSubCategories: any[] = [];
